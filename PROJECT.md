# Tirak Client Partnership

## Packet status

This is the canonical project entry point for the `tirak-backend-alpha01`
...
- Registry WorkObject: `branch:tirak` (`Tirak Client Partnership`, kind: program)
- GitHub: `Sheshiyer/tirak-backend-alpha01` (identity_status: pending-teamforge-verification)
- Knowledge authority: `60-client-ecosystem/tirak/project-brief.md`
