// W2.2 Stage D — live STAGING schema surface vs tirak-payments-v1 contract.
// Replays evidence/w22/staging-schema-post.json (live sqlite_schema dump) into an
...
function diffTable(table, expected, actual) {
  ...
  if (!actual) return [`${table}: missing from the live staging database`];
...
const dump = JSON.parse(readFileSync('evidence/w22/staging-schema-post.json', 'utf8'));
