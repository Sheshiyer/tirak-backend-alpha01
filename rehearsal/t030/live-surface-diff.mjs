// T-030 Stage D probe 1 — live rehearsal schema surface vs tirak-payments-v1 contract.
// Replays evidence/t030/rehearsal-schema.json (live sqlite_schema dump) into an
...
const dump = JSON.parse(readFileSync('evidence/t030/rehearsal-schema.json', 'utf8'));
